  ...
  return (
    <div
      ...
      style={{
        ...
        transform: hovered && !isFinished ? 'translateY(-6px) scale(1.01)' : 'translateY(0) scale(1)',
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px', position: 'relative' }}>
        ...
        <div style={{
          ...
          padding: '4px 12px',
          borderRadius: '20px',
          background: isFinished ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.2)',
          border: isFinished ? '1px solid rgba(255,255,255,0.1)' : '1px solid rgba(255,255,255,0.3)',
      ...
      {!isFinished ? (
        <>
          ...
          <CountdownTimer targetDate={item.time} onFinish={() => setIsFinished(true)} />
        </>
      ) : (
        <p style={{
          fontSize: '12px',
...
export default function App() {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      doc.setFontSize(12);
      doc.text("Official Auspicious Times Seettuwa", 105, 30, { align: 'center' });
      ...
      doc.text("Generated by Aurudu 2026 Portal • Suba Aluth Avuruddak Wewa!", 105, doc.internal.pageSize.height - 10, { align: 'center' });
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#0a0506' }}>
        ...
        <div style={{
          position: 'relative',
          background: 'linear-gradient(180deg, #4a0000 0%, #8B0000 40%, #6d0000 100%)',
          overflow: 'hidden',
          paddingBottom: '100px',
        }}>
          ...
          <div style={{
            ...
            {/* Live clock */}
            <div className="hero-text-4" style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: '24px',
              ...
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontSize: '10px', textTransform: 'uppercase', letterSpacing: '0.15em', opacity: 0.5, marginBottom: '4px' }}>
                  Sri Lanka Time
                </div>
                <div style={{
                  fontFamily: "'DM Mono', monospace",
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <div style={{ fontWeight: '600', display: 'flex', alignItems: 'center', gap: '6px', fontSize: '16px' }}>
          ...
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0 }}>
            <svg viewBox="0 0 1440 80" preserveAspectRatio="none" style={{ display: 'block', height: '80px' }}>
              <path d="M0,40 C360,80 1080,0 1440,40 L1440,80 L0,80 Z" fill="#0a0506" />
            </svg>
          </div>
        </div>
        ...
        <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 20px 80px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '48px', animation: 'heroReveal 0.6s 0.2s ease both' }}>
            <h2 style={{
              fontFamily: "'Playfair Display', serif",
              fontSize: '28px',
              fontWeight: '700',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px', alignItems: 'center' }}>
              ...
              <div>
                ...
                <p style={{
                  ...
                  The Sinhala and Tamil New Year (Aluth Avurudda) marks the Sun's transition from Pisces to Aries. A unique set of auspicious times (Nakath) calculated by astrologers ensures prosperity and harmony for the coming year.
                </p>
                <button
                  onClick={downloadPDF}
              ...
              <div style={{
                ...
                <h3 style={{
                  ...
                  color: '#fbbf24',
                  marginBottom: '20px'
                }}>2026 Colour Guide</h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  {[
                    { color: '#dc2626', label: 'Red', desc: 'New Year Dawn & Cooking' },
                    { color: '#16a34a', label: 'Green', desc: 'Oil Anointing Ritual' },
                    { color: '#f0f0f0', label: 'White', desc: 'Religious Acts & Work' },
                  ].map((c, i) => (
                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                      <div className="color-dot" style={{
                        background: c.color,
                        border: c.color === '#f0f0f0' ? '1px solid rgba(255,255,255,0.2)' : 'none',
                        boxShadow: `0 0 12px ${c.color}66`
                      }} />
                      <div>
                        <div style={{ fontWeight: '600', fontSize: '14px', color: 'rgba(255,255,255,0.9)' }}>{c.label}</div>
                        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)' }}>{c.desc}</div>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <footer style={{
            ...
            <p>© 2026 Aluth Avurudu Portal &nbsp;·&nbsp; සුභ අලුත් අවුරුද්දක් වේවා!</p>
          </footer>
        </main>
      </div>
    </>
